...
// DIR is deliberately absent.  It is tied to a rail at each driver; reverse is
// mechanically forbidden and a per-column direction fix is a wiring change, not
// a firmware one (spec 2, CLAUDE.md).  Phase 1 bench step 3 settles which rail.
